 ...
 */
vector<string>
FileUtility::read_textFile(string filepath)
{
...
bool
FileUtility::check_ExistanceAndAccess(string filepath)
{
...
vector<string>
FileUtility::globVector(string pattern)
{
 ...
 */
vector<string>
FileUtility::findDynaResultFiles(string _base_filepath)
{
