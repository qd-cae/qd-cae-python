...
extern int translate_secforc(int handle);
extern int translate_rwforc(int handle);
extern int translate_nodout(int handle);
extern int translate_curvout(int handle);
extern int translate_nodouthf(int handle);
extern int translate_elout(int handle);
extern int translate_eloutdet(int handle);
extern int translate_glstat(int handle);
extern int translate_ssstat(int handle);
extern int translate_deforc(int handle);
extern int translate_matsum(int handle);
extern int translate_ncforc(int handle);
extern int translate_rcforc(int handle);
extern int translate_spcforc(int handle);
extern int translate_swforc(int handle);
extern int translate_abstat(int handle);
extern int translate_abstat_cpm(int handle);
extern int translate_abstat_pbm(int handle);
extern int translate_cpm_sensor(int handle);
extern int translate_pgstat(int handle);
extern int translate_pg_sensor(int handle);
extern int translate_nodfor(int handle);
extern int translate_bndout(int handle);
extern int translate_rbdout(int handle);
extern int translate_gceout(int handle);
extern int translate_sleout(int handle);
extern int translate_sbtout(int handle);
extern int translate_jntforc(int handle);
extern int translate_sphout(int handle);
extern int translate_defgeo(int handle);
extern int translate_dcfail(int handle);
extern int translate_tprint(int handle);
extern int translate_trhist(int handle);
extern int translate_dbsensor(int handle);
extern int translate_dbfsi(int handle);
extern int translate_elout_ssd(int handle);
extern int translate_elout_spcm(int handle);
extern int translate_elout_psd(int handle);
extern int translate_nodout_ssd(int handle);
extern int translate_nodout_spcm(int handle);
extern int translate_nodout_psd(int handle);
extern int translate_pllyout(int handle);
extern int translate_dem_rcforc(int handle);
extern int translate_disbout(int handle);
extern int translate_dem_trhist(int handle);
extern int translate_traleh(int handle);
extern void l2a_set_output_path(char *pwd);
...
ENTRY list[NUM_ENTRIES] = {
    {"secforc",translate_secforc, 0},
...
void print_help(char *pname)
{
  ...
  printf("             the first input file is checked for a JOBID type prefix\n");
  printf("             and if found, this prefex is prepended to all output files\n\n");
}
...
*/
  ...
  /*  Must be a file name.  Add to list of files to open */
    if(j==NUM_ENTRIES) toopen[nopen++] = argv[i];
  }
  if(nopen == 0) exit(0);
  ...
  /* extract the jobid from the first target file */
      ...
      if(cp) {
        ...
        for(i=first; toopen[i]; i++)
          if(strncmp(outpath+2,toopen[i],len)==0) last=i;
      } else {
        outpath[2]=0;
        for(i=first; toopen[i]; i++)
          if(strchr(toopen[i],'.')==NULL) last=i;
      }
    }
